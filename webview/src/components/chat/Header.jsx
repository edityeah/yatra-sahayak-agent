...
// title, active-yatra subtitle, a phone (voice call) button, and a hamburger
// that opens the ThreadsDrawer (Chats/Settings). Matches the Pravasi Setu
// Assistant reference header.
